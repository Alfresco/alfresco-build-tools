...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/automate-propagation@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/awf-run-command@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/calculate-next-internal-version@v18.19.0
        with:
          next-version: 1.2.3
```
...
jobs:
  check-description:
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/check-pr-description@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/configure-git-author@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/dependabot-missing-actions-check@v18.19.0
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/dispatch-resume-workflow@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/docker-dump-containers-logs@v18.19.0
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/docker-scan-image-dirs@v18.19.0
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/enforce-pr-conventions@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/env-load-from-yaml@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/free-hosted-runner-disk-space@v18.19.0
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-branch-name-v2@v18.19.0
        id: branch-info
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-branch-name@v18.19.0
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-build-info@v18.19.0
```
...
jobs:
  cleanup:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/gh-cache-cleanup-on-merge@v18.19.0
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/git-check-existing-tag@v18.19.0
      with:
        tag: 1.0.0
```
...
```yaml
      ...
      - uses: actions/checkout@v3
        with:
          fetch-depth: 0
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-commit-message@v18.19.0
```
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/git-commit-changes@v18.19.0
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/git-latest-tag@v18.19.0
        with:
          pattern: 1.0.0-alpha*
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-check-upcoming-runs@v18.19.0
        with:
  ...
  job:
    ...
    steps:
      - name: Create Deployment
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/github-deployment-create@v18.19.0
        with:
      ...
      - name: Update Deployment State to failure
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/github-deployment-status-update@v18.19.0
        with:
          github-token: ${{ secrets.GITHUB_TOKEN }}
...
```yaml
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-deployments-delete@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/download-file@v18.19.0
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-https-auth@v18.19.0
        with:
          username: ${{ vars.BOT_GITHUB_USERNAME }}
...
```yaml
      - uses: actions/checkout@v6
        with:
          fetch-depth: 0
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-list-changes@v18.19.0
        with:
  ...
  check-dependabot:
    ...
    steps:
      - name: dependabot check
        id: dependabot
        uses: Alfresco/alfresco-build-tools/.github/actions/github-pr-check-metadata@v18.19.0
        with:
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-require-secrets@v18.19.0
        with:
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-trigger-approved-pr@v18.19.0
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-trigger-labeled-pr@v18.19.0
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-upsert-comment@v18.19.0
        with:
          comment-body: |
            ## Build Status
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-build-chart@v18.19.0
        with:
...
```yaml
      - name: Execute dry run
        uses: Alfresco/alfresco-build-tools/.github/actions/helm-integration-tests@v18.19.0
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/helm-package-chart@v18.19.0
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-parse-next-release@v18.19.0
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-publish-chart@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-release-and-publish@v18.19.0
        with:
          version: 1.0.0
          chart-dir: charts/common
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-template-yamllint@v18.19.0
        with:
...
```yaml
     - uses: >-
         Alfresco/alfresco-build-tools/.github/actions/helm-plugin@v18.19.0
       with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-update-chart-version@v18.19.0
        with:
          new-version: 1.0.0
```
  ...
  benchmark:
    ...
    steps:
      - name: Benchmark Production API
        uses: Alfresco/alfresco-build-tools/.github/actions/http-latency@v18.19.0
        id: benchmark
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/import-gpg-key@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/install-galaxy-deps@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/install-ubuntu-default-tools@v18.19.0
        with:
...
```yaml
      - name: Ensure Jira release
        id: jira
        uses: Alfresco/alfresco-build-tools/.github/actions/jira-get-or-create-release@v18.19.0
        with:
...
- name: Set Jira fix version (merge mode)
  id: jira
  uses: Alfresco/alfresco-build-tools/.github/actions/jira-set-fix-version@v18.19.0
  with:
    jira-url: ${{ vars.JIRA_URL }}
    jira-user: ${{ vars.JIRA_USER }}
    jira-token: ${{ secrets.JIRA_TOKEN }}
  ...
  propagate-release:
    ...
    steps:
      - name: Propagate Jira release
        uses: Alfresco/alfresco-build-tools/.github/actions/jira-propagate-release@v18.19.0
        with:
          jira-url: ${{ vars.JIRA_URL }}
...
```yaml
      - name: Promote version
        uses: Alfresco/alfresco-build-tools/.github/actions/jx-updatebot-pr@v18.19.0
        with:
...
```yaml
    - name: Upload pods logs
      if: always()
      uses: >-
        Alfresco/alfresco-build-tools/.github/actions/kubectl-keep-nslogs@v18.19.0
      with:
        namespace: mynsapp
        log_retention: 7
...
```yaml
    - name: Wait for pods to be ready
      uses: Alfresco/alfresco-build-tools/.github/actions/kubectl-wait@v18.19.0
      # with:
        # wait-timeout: 10m
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/load-release-descriptor@v18.19.0
        id: load-descriptor
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-configure@v18.19.0
        with:
          java-version: '21'
          maven-version: '3.8.8'
...
```yaml
- uses: Alfresco/alfresco-build-tools/.github/actions/maven-dependency-scan@v18.19.0
  with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-build@v18.19.0
        with:
          java-version: '21'
...
```yaml
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-build-and-tag@v18.19.0
        id: build-and-tag
        with:
...
```yaml
      - name: Deploy to Nexus
        uses: Alfresco/alfresco-build-tools/.github/actions/maven-deploy-file@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-release@v18.19.0
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/maven-update-pom-version@v18.19.0
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/md-toc@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/nexus-move-artifacts@v18.19.0
        with:
...
jobs:
  pre-commit:
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/pre-commit@v18.19.0
        with:
...
```yml
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/process-coverage-report@v18.19.0
        with:
          paths: |
...
```yml
      ...
      - uses: actions/setup-python@v4
        ...
        with:
          python-version: "3.11"
      - uses: Alfresco/alfresco-build-tools/.github/actions/pipenv@v18.19.0
        with:
...
```yaml
      - name: Register Cluster
        uses: Alfresco/alfresco-build-tools/.github/actions/rancher@v18.19.0
        with:
...
```yaml
      - name: Release Notes Aggregate
        uses: Alfresco/alfresco-build-tools/.github/actions/release-notes-aggregator@v18.19.0
        with:
...
[...]
    ...
    - name: Prepare Report Portal
      uses: Alfresco/alfresco-build-tools/.github/actions/reportportal-prepare@v18.19.0
      id: rp-prepare
      with:
    ...
    - name: Summarize Report Portal
      uses: Alfresco/alfresco-build-tools/.github/actions/reportportal-summarize@v18.19.0
      id: rp-summarize
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/resolve-preview-name@v18.19.0
...
```yml
      uses: Alfresco/alfresco-build-tools/.github/actions/send-teams-notification@v18.19.0
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-checkov@v18.19.0
        with:
          version: '3.2.0'
```
...
```yaml
      - name: Setup Docker Engine
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-docker@v18.19.0
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-fluxcli@v18.19.0
        with:
          version: '2.6.4'
```
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/setup-github-release-binary@v18.19.0
      with:
        repo: org/repo-name
        version: '1.2.3'
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-helm-docs@v18.19.0
        with:
          version: "1.14.2"
```
...
```yaml
      - name: Setup Java build
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-java-build@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-jx-release-version@v18.19.0
        with:
          version: "2.2.3"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-kcadm@v18.19.0
        with:
          version: "24.0.5"
```
...
```yaml
      - name: Setup cluster
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-kind@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-kubepug@v18.19.0
        with:
          version: "1.3.2"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-maven@v18.19.0
        with:
          version: "3.9.9"
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-pysemver@v18.19.0
        with:
          version: "2.13.0"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-rancher-cli@v18.19.0
        with:
          version: "2.9.2"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-terraform-docs@v18.19.0
        with:
          version: "0.16.0"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-updatebot@v18.19.0
        with:
          version: "1.1.60"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-updatecli@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/sonar-scan-on-built-project@v18.19.0
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/sonar-scanner@v18.19.0
        with:
          sonar-token: ${{ secrets.SONAR_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/update-project-base-tag@v18.19.0
        with:
          release-descriptor: release.yaml
          project: activiti
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/validate-maven-versions@v18.19.0
        with:
          maven-username: ${{ secrets.NEXUS_USERNAME }}
          maven-password: ${{ secrets.NEXUS_PASSWORD }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/veracode@v18.19.0
...
```yaml
      - name: Functional tests
        uses: Alfresco/alfresco-build-tools/.github/actions/xvfb-record@v18.19.0
        with:
...
jobs:
  promote:
    uses: Alfresco/alfresco-build-tools/.github/workflows/branch-promotion-prs.yml@v18.19.0
    with:
...
```yaml
  publish:
    uses: Alfresco/alfresco-build-tools/.github/workflows/helm-publish-new-package-version.yml@v18.19.0
    needs: build
    with:
      next-version: 7.4.0
      chart-dir: charts/common
...
jobs:
  mirror:
    uses: Alfresco/alfresco-build-tools/.github/workflows/reusable-repository-mirror.yml@v18.19.0
    with:
...
jobs:
  stale:
    uses: Alfresco/alfresco-build-tools/.github/workflows/stale-pr-cleanup.yml@v18.19.0
    with:
...
jobs:
    release:
        ...
        uses: Alfresco/alfresco-build-tools/.github/workflows/reusable-release.yml@v18.19.0
        with:
...
jobs:
  check:
    uses: Alfresco/alfresco-build-tools/.github/workflows/pr-review-check.yml@v18.19.0
    with:
