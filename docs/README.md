...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/calculate-next-internal-version@v17.6.1
        with:
          next-version: 1.2.3
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/configure-git-author@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/dependabot-missing-actions-check@v17.6.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/dispatch-resume-workflow@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/docker-dump-containers-logs@v17.6.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/docker-scan-image-dirs@v17.6.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/enforce-pr-conventions@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-branch-name-v2@v17.6.1
        id: branch-info
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-branch-name@v17.6.1
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-build-info@v17.6.1
```
...
jobs:
  cleanup:
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/gh-cache-cleanup-on-merge@v17.6.1
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/git-check-existing-tag@v17.6.1
      with:
        tag: 1.0.0
```
...
```yaml
      ...
      - uses: actions/checkout@v3
        with:
          fetch-depth: 0
      - uses: Alfresco/alfresco-build-tools/.github/actions/get-commit-message@v17.6.1
```
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/git-commit-changes@v17.6.1
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/git-latest-tag@v17.6.1
        with:
          pattern: 1.0.0-alpha*
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-check-upcoming-runs@v17.6.1
        with:
  ...
  job:
    ...
    steps:
      - name: Create Deployment
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/github-deployment-create@v17.6.1
        with:
      ...
      - name: Update Deployment State to failure
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/github-deployment-status-update@v17.6.1
        with:
          github-token: ${{ secrets.GITHUB_TOKEN }}
...
```yaml
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-deployments-delete@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/download-file@v17.6.1
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-https-auth@v17.6.1
        with:
          username: ${{ vars.BOT_GITHUB_USERNAME }}
...
```yaml
      - uses: actions/checkout@v6
        with:
          fetch-depth: 0
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-list-changes@v17.6.1
        with:
  ...
  check-dependabot:
    ...
    steps:
      - name: dependabot check
        id: dependabot
        uses: Alfresco/alfresco-build-tools/.github/actions/github-pr-check-metadata@v17.6.1
        with:
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-require-secrets@v17.6.1
        with:
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-trigger-approved-pr@v17.6.1
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
jobs:
  check:
    runs-on: ubuntu-latest
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/github-trigger-labeled-pr@v17.6.1
        with:
          github-token: ${{ secrets.BOT_GITHUB_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-build-chart@v17.6.1
        with:
...
```yaml
      - name: Execute dry run
        uses: Alfresco/alfresco-build-tools/.github/actions/helm-integration-tests@v17.6.1
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/helm-package-chart@v17.6.1
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-parse-next-release@v17.6.1
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-publish-chart@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-release-and-publish@v17.6.1
        with:
          version: 1.0.0
          chart-dir: charts/common
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-template-yamllint@v17.6.1
        with:
...
```yaml
     - uses: >-
         Alfresco/alfresco-build-tools/.github/actions/helm-plugin@v17.6.1
       with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/helm-update-chart-version@v17.6.1
        with:
          new-version: 1.0.0
```
  ...
  benchmark:
    ...
    steps:
      - name: Benchmark Production API
        uses: Alfresco/alfresco-build-tools/.github/actions/http-latency@v17.6.1
        id: benchmark
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/install-galaxy-deps@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/install-ubuntu-default-tools@v17.6.1
        with:
...
```yaml
      - name: Ensure Jira release
        id: jira
        uses: Alfresco/alfresco-build-tools/.github/actions/jira-get-or-create-release@v17.6.1
        with:
...
- name: Set Jira fix version (merge mode)
  id: jira
  uses: Alfresco/alfresco-build-tools/.github/actions/jira-set-fix-version@v17.6.1
  with:
    jira-url: ${{ vars.JIRA_URL }}
    jira-user: ${{ vars.JIRA_USER }}
    jira-token: ${{ secrets.JIRA_TOKEN }}
  ...
  propagate-release:
    ...
    steps:
      - name: Propagate Jira release
        uses: Alfresco/alfresco-build-tools/.github/actions/jira-propagate-release@v17.6.1
        with:
          jira-url: ${{ vars.JIRA_URL }}
...
```yaml
      - name: Promote version
        uses: Alfresco/alfresco-build-tools/.github/actions/jx-updatebot-pr@v17.6.1
        with:
...
```yaml
    - name: Upload pods logs
      if: always()
      uses: >-
        Alfresco/alfresco-build-tools/.github/actions/kubectl-keep-nslogs@v17.6.1
      with:
        namespace: mynsapp
        log_retention: 7
...
```yaml
    - name: Wait for pods to be ready
      uses: Alfresco/alfresco-build-tools/.github/actions/kubectl-wait@v17.6.1
      # with:
        # wait-timeout: 10m
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/load-release-descriptor@v17.6.1
        id: load-descriptor
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-configure@v17.6.1
        with:
          java-version: '21'
          maven-version: '3.8.8'
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-build@v17.6.1
        with:
          java-version: '21'
...
```yaml
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-build-and-tag@v17.6.1
        id: build-and-tag
        with:
...
```yaml
      - name: Deploy to Nexus
        uses: Alfresco/alfresco-build-tools/.github/actions/maven-deploy-file@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/maven-release@v17.6.1
        with:
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/maven-update-pom-version@v17.6.1
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/md-toc@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/nexus-move-artifacts@v17.6.1
        with:
...
jobs:
  pre-commit:
    ...
    steps:
      - uses: Alfresco/alfresco-build-tools/.github/actions/pre-commit@v17.6.1
        with:
...
```yml
        ...
        uses: Alfresco/alfresco-build-tools/.github/actions/process-coverage-report@v17.6.1
        with:
          paths: |
...
```yml
      ...
      - uses: actions/setup-python@v4
        ...
        with:
          python-version: "3.11"
      - uses: Alfresco/alfresco-build-tools/.github/actions/pipenv@v17.6.1
        with:
...
```yaml
      - name: Register Cluster
        uses: Alfresco/alfresco-build-tools/.github/actions/rancher@v17.6.1
        with:
...
```yaml
      - name: Release Notes Aggregate
        uses: Alfresco/alfresco-build-tools/.github/actions/release-notes-aggregator@v17.6.1
        with:
...
[...]
    ...
    - name: Prepare Report Portal
      uses: Alfresco/alfresco-build-tools/.github/actions/reportportal-prepare@v17.6.1
      id: rp-prepare
      with:
    ...
    - name: Summarize Report Portal
      uses: Alfresco/alfresco-build-tools/.github/actions/reportportal-summarize@v17.6.1
      id: rp-summarize
      with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/resolve-preview-name@v17.6.1
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-checkov@v17.6.1
        with:
          version: '3.2.0'
```
...
```yaml
      - name: Setup Docker Engine
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-docker@v17.6.1
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-fluxcli@v17.6.1
        with:
          version: '2.6.4'
```
...
```yaml
    - uses: Alfresco/alfresco-build-tools/.github/actions/setup-github-release-binary@v17.6.1
      with:
        repo: org/repo-name
        version: '1.2.3'
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-helm-docs@v17.6.1
        with:
          version: "1.14.2"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-jx-release-version@v17.6.1
        with:
          version: "2.2.3"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-kcadm@v17.6.1
        with:
          version: "24.0.5"
```
...
```yaml
      - name: Setup cluster
        uses: Alfresco/alfresco-build-tools/.github/actions/setup-kind@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-kubepug@v17.6.1
        with:
          version: "1.3.2"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-pysemver@v17.6.1
        with:
          version: "2.13.0"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-rancher-cli@v17.6.1
        with:
          version: "2.9.2"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-terraform-docs@v17.6.1
        with:
          version: "0.16.0"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-updatebot@v17.6.1
        with:
          version: "1.1.60"
```
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/setup-updatecli@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/sonar-scan-on-built-project@v17.6.1
        with:
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/sonar-scanner@v17.6.1
        with:
          sonar-token: ${{ secrets.SONAR_TOKEN }}
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/update-project-base-tag@v17.6.1
        with:
          release-descriptor: release.yaml
          project: activiti
...
```yaml
      - uses: Alfresco/alfresco-build-tools/.github/actions/validate-maven-versions@v17.6.1
        with:
          maven-username: ${{ secrets.NEXUS_USERNAME }}
          maven-password: ${{ secrets.NEXUS_PASSWORD }}
...
```yaml
      - name: Functional tests
        uses: Alfresco/alfresco-build-tools/.github/actions/xvfb-record@v17.6.1
        with:
...
jobs:
  promote:
    uses: Alfresco/alfresco-build-tools/.github/workflows/branch-promotion-prs.yml@v17.6.1
    with:
...
```yaml
  publish:
    uses: Alfresco/alfresco-build-tools/.github/workflows/helm-publish-new-package-version.yml@v17.6.1
    needs: build
    with:
      next-version: 7.4.0
      chart-dir: charts/common
...
jobs:
  mirror:
    uses: Alfresco/alfresco-build-tools/.github/workflows/reusable-repository-mirror.yml@v17.6.1
    with:
...
jobs:
    release:
        ...
        uses: Alfresco/alfresco-build-tools/.github/workflows/reusable-release.yml@v17.6.1
        with:
...
jobs:
  check:
    uses: Alfresco/alfresco-build-tools/.github/workflows/pr-review-check.yml@v17.6.1
    with:
