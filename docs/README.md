...
By using the `rp-static-launch-name` flag, you can determine whether 'LAUNCH_NAME' should be static or unique for each execution. By default, it is set to `false`.
